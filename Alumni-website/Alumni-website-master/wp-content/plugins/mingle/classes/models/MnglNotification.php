...
MAIL_BODY;
  ...
  /** Send notification that the your board post or a board post you've commented on was commented on
    */
  public static function board_commented($board_comment_id)
  {
...
MAIL_BODY;
  ...
  public static function send_notification_email($user, $subject, $message, $message_type)
  {
    global $mngl_blogname, $mngl_options;
  ...
  public static function get_mail_signature()
  {
