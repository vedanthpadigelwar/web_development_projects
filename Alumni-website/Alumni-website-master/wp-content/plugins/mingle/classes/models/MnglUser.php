...
class MnglUser { 
  ...
  {
    return '<a href="'.$this->get_profile_url().'">'.((empty($name))?$this->first_name.' '.$this->last_name:$name).'</a>';
  }
  ...
  public static function get_stored_profile_by_screenname($screenname = '', $load_default = true)
  {
    $user = '';
  ...
  { 
    ...
    {
      $current_user = MnglUtils::get_currentuserinfo();
  ...
  public static function get_stored_profiles($search_query='', $offset=0, $limit=50, $order_by='user_login ASC')
  {
  ...
  public static function get_count($add_where='')
  {
    global $wpdb, $mngl_options;
  ...
  public static function user_exists_and_visible($user_id)
  {
    global $mngl_options;
  ...
  public static function screenname_exists($screenname)
  {
    $user = false;
  ...
  public static function screenname_exists_and_visible($screenname)
  {
    global $mngl_options;
