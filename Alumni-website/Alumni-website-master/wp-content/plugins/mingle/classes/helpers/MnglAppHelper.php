...
class MnglAppHelper {
  ...
  public static function time_ago($created_at_ts)
  {
    ...
    if($ago < $minutes)
    {
      $ago_str = sprintf(_n("%d second ago","%d seconds ago", $ago, 'mingle'), $ago);
    }
    else if($ago < $hours)
    {
      $ago_minutes = (int)($ago / $minutes);
      
      $ago_str = sprintf(_n("%d minute ago", "%d minutes ago", $ago_minutes, 'mingle'), $ago_minutes);
    }
    else if($ago < $days)
    {
      $ago_hours = (int)($ago / $hours);
      
      $ago_str = sprintf(_n("%d hour ago", "%d hours ago", $ago_hours, 'mingle'), $ago_hours);
    }
    else if($ago < $weeks)
    {
      $ago_days = (int)($ago / $days);
      
      $ago_str = sprintf(_n("yesterday", "%d days ago", $ago_days, 'mingle'), $ago_days);
    }
    else if($ago < $months)
    {
      $ago_weeks = (int)($ago / $weeks);
      
      $ago_str = sprintf(_n("last week", "%d weeks ago", $ago_weeks, 'mingle'), $ago_weeks);
    }
    else if($ago < $years)
    {
      $ago_months = (int)($ago / $months);
      
      $ago_str = sprintf(_n("last month", "%d months ago", $ago_months, 'mingle'), $ago_months);
    }
    else
    {
      $ago_years = (int)($ago / $years);
      
      $ago_str = sprintf(_n("last year", "%d years ago", $ago_years, 'mingle'), $ago_years);
    }
  ...
  public static function value_is_checked_with_array($field_name, $index, $field_value)
  {
    if( isset($_POST['action']) and 
        ( ( $_POST['action'] == 'process_form' and isset( $_POST[ $field_name ][ $index ] ) ) or
