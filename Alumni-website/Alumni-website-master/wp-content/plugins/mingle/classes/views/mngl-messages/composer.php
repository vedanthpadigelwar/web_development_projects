...
<form action="" enctype="multipart/form-data" method="post" autocomplete="off">
  ...
  <table width="100%" class="profile-edit-table">
    <tr>
      ...
      <td valign="top">
				<input type="text" name="mngl_message_recipients" id="mngl_message_recipients" class="mngl-profile-edit-field form-control" value="<?php echo isset($to)?$to:''; ?>" />
      </td>
    </tr>
    <tr>
      <td valign="top"><?php _e('Subject', 'mingle'); ?>:</td>
      <td valign="top"><input type="input" name="mngl_message_subject" id="mngl_message_subject" value="<?php echo isset($_POST['mngl_message_subject'])?MnglAppHelper::format_text($_POST['mngl_message_subject']):''; ?>" class="mngl-profile-edit-field form-control" /></td>
    </tr>
    <tr>
      <td valign="top"><?php _e('Message', 'mingle'); ?>:</td>
      <td valign="top"><textarea name="mngl_message_body" id="mngl_message_body" class="mngl-profile-edit-field mngl-growable form-control"><?php echo isset($_POST['mngl_message_body'])?MnglAppHelper::format_text($_POST['mngl_message_body']):''; ?></textarea></td>
    </tr>
  </table>
  <input type="submit" class="mngl-share-button submit-btn" name="Update" value="<?php _e('Send', 'mingle'); ?>" />
</form>
</div>
