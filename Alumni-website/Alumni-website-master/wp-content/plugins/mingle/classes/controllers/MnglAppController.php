...
class MnglAppController
{
  ...
  function menu()
  {
    ...
    add_menu_page(__('Mingle', 'mingle'), __('Mingle', 'mingle'), 'remove_users', 'mingle-options', array($mngl_options_controller,'route'), MNGL_URL . "/images/mingle_16.png");
    add_submenu_page( 'mingle-options', __('Options', 'mingle'), __('Options', 'mingle'), 'remove_users', 'mingle-options', array($mngl_options_controller,'route') );
  }
  ...
  function mingle_init()
  {
    ...
    add_filter('get_comment_author_url', array($this,'override_author_url'), 11, 3);
  }
  
  function override_author_url($url, $comment_id, $comment)
  {
    // global $comment;
