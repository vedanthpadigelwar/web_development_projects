...
class MnglProfileHelper
{
  ...
  { 
    ...
    ?>
      <select  name="<?php echo $field_name; ?>" id="<?php echo $field_name; ?>" class="mngl-dropdown form-control mngl-sex-dropdown<?php echo $classes; ?>"<?php echo $tabindex; ?>>
        <option selected="selected" value="female"<?php MnglAppHelper::value_is_selected($field_name, $field_value, "female"); ?>><?php _e('Female', 'mingle'); ?>&nbsp;</option>
  ...
  {
    ?>
      <select name="<?php echo $field_name; ?>" id="<?php echo $field_name; ?>" class="mngl-dropdown mngl-privacy-dropdown form-control">
