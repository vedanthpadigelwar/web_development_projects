...
function mngl_bulk_action()
{
  ...
  jQuery.ajax( {
    ...
    success: function(html) {
      ...
      {
        jQuery('.mngl_message_checkbox:checked').parent().parent().children().css('background-color','rgba(228,227,223,0.8)');
      }
      else if(action=='mark_read')
      {
        jQuery('.mngl_message_checkbox:checked').parent().parent().children().css('background-color','rgba(228,227,223,0.3)');
      }
