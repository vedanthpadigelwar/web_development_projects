		...
		<form id="new-post" name="new-post" method="post" action="<?php the_permalink(); ?>">
			...
			<fieldset class="bbp-form">
				...
				<div>
                    ...
                    <div class="tagswrap">
                    <div class="tagswrap-dark">
					<p>
						<input type="text" id="bbp_topic_title" value="<?php bbp_form_topic_title(); ?>" tabindex="<?php bbp_tab_index(); ?>" size="40" placeholder="<?php printf( __( 'Topic Title (Maximum Length: %d):', 'bbpress' ), bbp_get_title_max_length() ); ?>" name="bbp_topic_title" maxlength="<?php bbp_title_max_length(); ?>"  class="form-control"/>
					</p>
					</div>
                    </div>
					...
					<div class="bbp-submit-wrapper">
						...
						<button type="submit" tabindex="<?php bbp_tab_index(); ?>" id="bbp_topic_submit" name="bbp_topic_submit" class="button submit submit-btn"><?php _e( 'Submit', 'bbpress' ); ?></button>
