...
class MnglCustomFieldsHelper
{
  ...
  function text_input($field, $value, $classes='')
  {
    ...
    ?>
      <input type="text" placeholder="<?php echo stripslashes($field['name']); ?>" name="mngl_custom[<?php echo $field['id']; ?>]" id="mngl_custom[<?php echo $field['id']; ?>]" class="mngl-text-input <?php echo $classes; ?> form-control col-md-12" value="<?php echo stripslashes($curr_val); ?>" />
    <?php
  }
