      ...
      <tr>
        ...
        <td valign="top" class="mngl-valign-top">
          <div class="mngl-board-comment-message">
            <a href="<?php echo $comment_author->get_profile_url(); ?>"><?php echo "{$comment_author->first_name} {$comment_author->last_name}"; ?></a> <?php MnglBoardsHelper::display_message('mngl-board-comment-message-'.$comment->id, $comment->message, false); ?><br/>
            ...
            if($mngl_user and (($mngl_user->id == $mngl_board_post->owner_id) or ($mngl_user->id == $comment->author_id) or current_user_can('level_10')))
            {
