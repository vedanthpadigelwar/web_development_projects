    ...
    <table class="mngl-comment-table">
     <tr>
       ...
       <td valign="top" class="mngl-comment-table-col-2">
         <textarea id="mngl-board-comment-input-<?php echo $board_post_id; ?>" class="mngl-board-input mngl-comment-board-input mngl-growable mngl-twoline form-control"></textarea>
       </td>
     </tr>
    </table>
    <table class="mngl-comment-table">
