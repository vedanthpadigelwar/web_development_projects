...
<body>
    ...
    <font size="6" color="#FFFF00">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Student Attendance System</font>
        ...
        <div class="cleaner_h30"></div>
         ...
         <tr><td><font color="white"> Subject 1 :</td><td><input type="text" name="sub1" required="" /></td></tr>
         <tr><td><font color="white"> Subject 2:</td><td><input type="text" name="sub2" /></td></tr>
         <tr><td><font color="white"> Subject 3:</td><td><input type="text" name="sub3" /></td></tr>
         <tr><td><font color="white"> Subject 4:</td><td><input type="text" name="sub4" /></td></tr>
         <tr><td><font color="white"> Subject 5:</td><td><input type="text" name="sub5" /></td></tr>
         <tr><td><font color="white"> Subject 6:</td><td><input type="text" name="sub6" /></td></tr>
